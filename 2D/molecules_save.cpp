...
void scale(char zoom)
{
    ...
    if (H2O_centers[0][0] < H2O_centers[1][0])
        H2O_centers[0][0] = H2O_centers[1][0] - d_new_1 / (sqrt(1 + m1 * m1));
    else
        H2O_centers[0][0] = H2O_centers[1][0] + d_new_1 / (sqrt(1 + m1 * m1));

    if (H2O_centers[0][1] < H2O_centers[1][1])
        H2O_centers[0][1] = H2O_centers[1][1] - m1 * d_new_1 / (sqrt(1 + m1 * m1));
    else
        H2O_centers[0][1] = H2O_centers[1][1] + m1 * d_new_1 / (sqrt(1 + m1 * m1));
    ...
    if (H2O_centers[2][0] < H2O_centers[1][0])
        H2O_centers[2][0] = H2O_centers[1][0] - d_new_2 / (sqrt(1 + m2 * m2));
    else
        H2O_centers[2][0] = H2O_centers[1][0] + d_new_2 / (sqrt(1 + m2 * m2));

    if (H2O_centers[2][1] < H2O_centers[1][1])
        H2O_centers[2][1] = H2O_centers[1][1] - m2 * d_new_2 / (sqrt(1 + m2 * m2));
    else
        H2O_centers[2][1] = H2O_centers[1][1] + m2 * d_new_2 / (sqrt(1 + m2 * m2));
